  ...
  const products = {
    ...
    handlerEvent: function () {
      ...
      wrapperDetail.onclick = function (e) {
        ...
        const modelDelete = e.target.closest(".model-detele");
        ...
        if (modelDelete) {
          modelDelete.addEventListener("click", function (e) {
        ...
        if (btnDeleteCart) {
          const modelDelete = $(".model-detele");
          console.log("modelDelete:", modelDelete);
