  ...
  try {
    await fetch(`${http}user/check`, {
      headers: {
        "Content-Type": "application/json",
        authentication:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InNpZXV4YXU1MEBnbWFpbC5jb20iLCJ1c2VybmFtZSI6IjIwMTEwNjE1NDMiLCJpYXQiOjE2ODI0MzY2NjMsImV4cCI6MTY4MjUyMzA2M30.hc6Ql7Uwd_rWDM_59-NXas32-v954So2UtMslDbVa-w",
      },
    })
      .then((data) => data.json())
      .then((data) => {
