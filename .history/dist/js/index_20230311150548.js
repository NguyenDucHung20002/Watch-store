      ...
      const getCountProducts = await fetch(
        ...
        .then((data) => {
          ...
          if (countPage <= 5) {
            ...
            <li class="col active" data-page="1">1</li>
            <li class="col" data-page="2">2</li>
            <li class="col" data-page="3">3</li>
            <li class="col" data-page="4">4</li>
            <li class="col" data-page="5">5</li>
            <li class="col">...</li>
            <li class="col  last-page data-page="${countPage}"">${countPage}</li>
            <li class="col  next"><i class="fa-solid fa-angles-right"></i></li>
           `;
          }
