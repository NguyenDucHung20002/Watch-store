          ...
          return `
            <div class="product col-6  col-lg-3" >
                  ...
                  <div class="handle-product">
                    <button class="delete-cart" data-id=${val._id}><i class="fa-solid fa-bag-shopping"></i></i> Add To Cart</button>
                    <button class="update-cart" data-id=${val._id}><i class="fa-solid fa-bag-shopping"></i></i> Add To Cart</button>
                </div>
