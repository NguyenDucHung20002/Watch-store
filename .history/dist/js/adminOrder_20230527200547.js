    ...
    data.forEach((val) => {
      ...
      const actionStatus = !status
        ? `<div class="action-deliverable">
            ...
            <button class="btn-deliverable" data-id="${val?._id}">Deliverable</button>
          </div>`
        : status == 1
        ? `<div class="action-deliverable">
