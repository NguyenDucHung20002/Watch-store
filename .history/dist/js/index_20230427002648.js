...
const expired = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InNpZXV4YXU1MEBnbWFpbC5jb20iLCJ1c2VybmFtZSI6IjIwMTEwNjE1NDMiLCJpYXQiOjE2ODI0MzY2NjMsImV4cCI6MTY4MjUyMzA2M30.hc6Ql7Uwd_rWDM_59-NXas32-v954So2UtMslDbVa-w`;
spinner(true);
let likes = [];
if (User) {
  checkUser();
...
async function checkUser() {
  try {
    await fetch(`${HTTP}user/check/${expired}`, {
      headers: {
...
//     .then((data) => {
//       if (data.success) {
//         const websiteTraffic = data.data[0].websiteTraffic + 1;
...
//             authentication: User.token,
//           },
//           body: JSON.stringify({ websiteTraffic }),
//         });
//       }
//     });
// }
