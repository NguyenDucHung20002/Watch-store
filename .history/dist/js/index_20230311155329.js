        ...
        .then((data) => {
          ...
          if (countPage <= 5) {
           ...
           `;
            ...
            <li class="col " data-page="${pageNow - 2}"><a href="#">1</a></li>
            <li class="col" data-page="${pageNow - 1}"><a href="#">2</a></li>
            <li class="col active" data-page="${pageNow}"><a href="#">3</a></li>
            <li class="col" data-page="${pageNow + 1}"><a href="#">4</a></li>
            <li class="col" data-page="${pageNow + 2}"><a href="#">5</a></li>
            <li class="col">...</li>
            <li class="col  last-page data-page="${countPage}""><a href="#">${countPage}</a></li>
            <li class="col  next"><i class="fa-solid fa-angles-right"></i></li>
           `;
