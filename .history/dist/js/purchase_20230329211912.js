    ...
    <div class="checkout-item">
          ...
          <div class="checkout-detail row">
              <div class="products col-12 col-md-7">
                  ${renderProduct(val.purchase.carts)}
              </div>
              <div class="bill col-12 col-md-5">
                  <div class="checkout-info">
                      <div class="address">
                          ...
                          <div class="live phone-number">${
                            val.purchase.phone
                          }</div>
                          <div class="live email">${val.purchase.email}</div>
                          <div class="live stress">${
                            val.purchase.streetAddress
                          }</div>
                          <div class="live coutry-city">${
                            val.purchase.city
                          }</div>
                          <h2 class="subtotal">
...
window.addEventListener("load", function () {
  ...
  fetch(`${http}purchase/user/${User.data?.idUser}`, {
    ...
    .then((data) => {
      if (data.success) {
        console.log("data:", data.data[0].purchase.carts.imgBg);
