...
window.addEventListener("load", function () {
  ...
  const products = {
    ...
    page: async function (pageNow, limit) {
        ...
        .then((data) => {
          ...
          if (countPage <= 5) {
           ...
           `;
            ...
            navPage.innerHTML = `
            <li class="col prev"><i class="fa-solid fa-angles-left"></i></li>
            <li class="col  last-page data-page="1"><a href="#">1</a></li>
            <li class="col " data-page="${pageNow - 2}"><a href="#">${
              pageNow - 2
            }</a></li>
            <li class="col" data-page="${pageNow - 1}"><a href="#">${
              pageNow - 1
            }</a></li>
            <li class="col active" data-page="${pageNow}"><a href="#">${pageNow}</a></li>
            <li class="col" data-page="${pageNow + 1}"><a href="#">${
              pageNow + 1
            }</a></li>
            <li class="col" data-page="${pageNow + 2}"><a href="#">${
           ...
           `;
            ...
            const pageOneTwo =
              pageNow === countPage - 2
                ? ` <li class="col active" data-page="${
                    countPage - 2
                  }"><a href="#">${countPage - 2}</a></li>
            <li class="col" data-page="${countPage - 1}"><a href="#">${
                    countPage - 1
                  }</a></li>
            <li class="col" data-page="${countPage}"><a href="#">${countPage}</a></li>`
                : pageNow === countPage - 1
                ? ` <li class="col " data-page="${countPage - 2}"><a href="#">${
                    countPage - 2
                  }</a></li>
            <li class="col active" data-page="${countPage - 1}"><a href="#">${
                    countPage - 1
                  }</a></li>
            <li class="col" data-page="${countPage}"><a href="#">${countPage}</a></li>`
                : ` <li class="col " data-page="${countPage - 2}"><a href="#">${
            ...
            <li class="col active" data-page="${countPage}"><a href="#">${countPage}</a></li>`;
            navPage.innerHTML = `
            <li class="col prev"><i class="fa-solid fa-angles-left"></i></li>
            <li class="col  last-page data-page="1""><a href="#">1</a></li>
            <li class="col" data-page="${countPage - 4}"><a href="#">${
              countPage - 4
            }</a></li>
            <li class="col" data-page="${countPage - 3}"><a href="#">${
              countPage - 3
            }</a></li>
            ${pageOneTwo}
            <li class="col  next"><i class="fa-solid fa-angles-right"></i></li>
    ...
    product: async function (page, limit) {
      await fetch(
