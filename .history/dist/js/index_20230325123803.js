          ...
          return `
            <div class="product col-6  col-lg-3" >
                    ...
                    <div class="wrapper-rating">
                      ...
                      <button data-id="${val._id}" class="like"><i class="fa-solid fa-thumbs-up"></i></button>
                  </div>
                </div>
        `;
        });
        ...
        if (btnLike) {
          ...
          fetch(`${_this.HTTP}/like/user/${userId}`, {
            ...
            .then((data) => {
              ...
              const indexLike = data.data.findIndex(
                (val) => val._id === dataId
              );
              console.log("indexLike:", indexLike);
              if (indexLike >= 0) {
                likes = data.data.filter((val) => val._id !== dataId);
              } else {
                console.log("ngao nghe");
