...
window.addEventListener("load", function () {
  ...
  const products = {
    ...
    page: async function (pageNow = 1, limit = 4) {
        ...
        .then((data) => {
          ...
          if (countPage <= 5) {
           ...
           `;
            ...
            navPage.innerHTML = `
            <li class="col prev"><i class="fa-solid fa-angles-left"></i></li>
            <li class="col page last-page" data-page="1"><a href="#">1</a></li>
           ...
           `;
            ...
            <li class="col page" data-page="${countPage}"><a href="#">${countPage}</a></li>`
                : pageNow === countPage - 1
            ...
            <li class="col page active" data-page="${countPage}"><a href="#">${countPage}</a></li>`;
            navPage.innerHTML = `
            <li class="col prev"><i class="fa-solid fa-angles-left"></i></li>
            <li class="col page" data-page="1"><a href="#">1</a></li>
            ...
            <li class="col page last-page" data-page="${
              countPage - 3
    ...
    product: async function (page = 1, limit = 4) {
      await fetch(
    ...
    handlerEvent: function () {
      ...
      pagination.onclick = function (e) {
        ...
        const lastPageElement = e.target.closest(".last-page");
